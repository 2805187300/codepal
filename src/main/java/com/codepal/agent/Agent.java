...
import com.codepal.conversation.ThinkingBlock;
import com.codepal.conversation.ToolResultBlock;
import com.codepal.conversation.ToolUseBlock;
import com.codepal.hook.HookEngine;
import com.codepal.llm.LlmClient;
import com.codepal.llm.StreamEvent;
...
import com.codepal.toolresult.ContentReplacementRecord;
import com.codepal.toolresult.ContentReplacementState;
import com.codepal.toolresult.ReplacementRecordsIO;
import com.codepal.toolresult.ToolResultBudget;
...
public class Agent {
    ...
    private final com.codepal.compact.ContextCompactor.AutoCompactTrackingState compactTracking =
            new com.codepal.compact.ContextCompactor.AutoCompactTrackingState();
     ...
     */
    private final com.codepal.compact.RecoveryState recoveryState =
            new com.codepal.compact.RecoveryState();

    public com.codepal.compact.RecoveryState getRecoveryState() { return recoveryState; }

    private com.codepal.filehistory.FileHistory fileHistory;
    public void setFileHistory(com.codepal.filehistory.FileHistory fh) { this.fileHistory = fh; }
    public com.codepal.filehistory.FileHistory getFileHistory() { return fileHistory; }
    ...
    private void agentLoop(ConversationManager conv, BlockingQueue<AgentEvent> queue) {
        ...
        for (int iteration = 1; ; iteration++) {
            ...
            Path sessionDir = Paths.get(workDir == null ? "." : workDir, ".codepal/session");
            ...
            try {
                ...
                String compactMsg = com.codepal.compact.ContextCompactor.manage(
            ...
            if (streamError) {
                ...
                if (lastErr != null && (lastErr.contains("context") || lastErr.contains("too long")
                    ...
                    if (contextRetries < 3) {
                        ...
                        Path forceSessionDir = Paths.get(workDir == null ? "." : workDir, ".codepal/session");
                        ...
                        try {
                            ...
                            com.codepal.compact.ContextCompactor.forceCompact(
            ...
            com.codepal.metrics.MetricsCollector.getInstance().recordTokens(turnInput, turnOutput);
            com.codepal.metrics.MetricsCollector.getInstance().recordTurnComplete();
