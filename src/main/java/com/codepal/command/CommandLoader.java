...
/**
 * 从 .codepal/commands/ 目录加载自定义 Markdown 命令文件。
...
public final class CommandLoader {
    ...
    /**
     * 合并用户全局和项目级的文件命令。
     * 搜索路径：1. ~/.codepal/commands/  2. $workDir/.codepal/commands/
     * 后者覆盖前者同名命令。
     */
    public static List<Command> loadUserCommands(String workDir) {
        ...
        if (home != null && !home.isEmpty()) {
            dirs.add(Path.of(home, ".codepal", "commands").toString());
        }
        dirs.add(Path.of(workDir, ".codepal", "commands").toString());
