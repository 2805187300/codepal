...
public class HistoryStore {
    ...
    /** Default constructor &mdash; stores history in {@code ~/.codepal/prompt_history.jsonl}. */
    public HistoryStore() {
        this(Path.of(System.getProperty("user.home"), ".codepal", "prompt_history.jsonl"));
    }
