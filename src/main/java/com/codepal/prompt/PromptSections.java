...
package com.codepal.prompt;

import com.codepal.prompt.PromptBuilder.EnvironmentContext;
import com.codepal.prompt.PromptBuilder.Section;
...
public final class PromptSections {
    ...
    static final String IDENTITY_CONTENT = """
            You are CodePal, an AI programming assistant running in the terminal. You help users with \
