 ...
 * ({@code ~/.codepal/skills/}) → project ({@code .codepal/skills/}),
...
public class SkillCatalog {
    ...
    private static List<String> skillDirPaths(String workDir) {
        ...
        String home = System.getProperty("user.home");
        if (home != null) {
            dirs.add(Path.of(home, ".codepal", "skills").toString());
        }
        if (workDir != null) {
            dirs.add(Path.of(workDir, ".codepal", "skills").toString());
        }
        return dirs;
    }
