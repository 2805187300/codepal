 ...
 *   <li>User-level definitions from {@code ~/.codepal/agents/*.md}</li>
 *   <li>Project-level definitions from {@code <projectRoot>/.codepal/agents/*.md}</li>
 * </ol>
...
public final class AgentLoader {
    ...
    public static Map<String, SubAgentSpec> loadAll(Path projectRoot) {
        ...
        if (home != null && !home.isEmpty()) {
            loader.loadDir(Path.of(home, ".codepal", "agents"));
        }

        if (projectRoot != null) {
            loader.loadDir(projectRoot.resolve(".codepal").resolve("agents"));
        }
