...
public class AgentTool implements Tool {
    ...
    private com.codepal.worktree.WorktreeManager worktreeManager;

    /** Optional: team manager for team_name registration. */
    private com.codepal.teams.TeamManager teamManager;
     ...
     */
    private com.codepal.toolresult.ContentReplacementState parentReplacementState;

    public void setParentReplacementState(com.codepal.toolresult.ContentReplacementState state) {
        this.parentReplacementState = state;
    }

    public void setWorktreeManager(com.codepal.worktree.WorktreeManager worktreeManager) {
        this.worktreeManager = worktreeManager;
    }

    public void setTeamManager(com.codepal.teams.TeamManager teamManager) {
        ...
        for (var msg : parent.getMessages()) {
            if (msg.getToolUses() != null && !msg.getToolUses().isEmpty()
                ...
                var placeholders = msg.getToolUses().stream()
                        .map(tu -> new com.codepal.conversation.ToolResultBlock(
    ...
    private ToolResult runSync(SubAgentSpec spec, String description, String prompt, String modelOverride, String isolation) {
        ...
        com.codepal.worktree.AgentWorktree.Result wtResult = null;
        if ("worktree".equals(isolation) && worktreeManager != null) {
            ...
            try {
                wtResult = com.codepal.worktree.AgentWorktree.create(
                ...
                String notice = com.codepal.worktree.AgentWorktree.buildNotice(
        ...
        while (true) {
            ...
            switch (event) {
                ...
                case AgentEvent.LoopComplete lc -> {
                    ...
                    String wtInfo = "";
                    if (wtResult != null) {
                        if (com.codepal.worktree.WorktreeChanges.hasChanges(
                            ...
                            com.codepal.worktree.AgentWorktree.remove(
    ...
    private ToolResult runAsTeammate(SubAgentSpec spec, String teamName,
        ...
        subRegistry.register(new com.codepal.teams.TeamTools.SendMessageTool(teamManager, memberName));
        // 团队共享任务板工具：队友之间共享同一份任务列表（覆盖个人版同名工具）
        subRegistry.register(new com.codepal.teams.TeamTaskTools.TaskCreateTool(teamManager, teamName, memberName));
        subRegistry.register(new com.codepal.teams.TeamTaskTools.TaskGetTool(teamManager, teamName));
        subRegistry.register(new com.codepal.teams.TeamTaskTools.TaskListTool(teamManager, teamName));
        subRegistry.register(new com.codepal.teams.TeamTaskTools.TaskUpdateTool(teamManager, teamName));
        ...
        // Build addendum
        String addendum = com.codepal.teams.TeammateRunner.buildTeammateAddendum(
        ...
        if ("worktree".equals(isolation) && worktreeManager != null) {
            try {
                ...
                new java.security.SecureRandom().nextBytes(rndBytes);
                String slug = "agent-a" + java.util.HexFormat.of().formatHex(rndBytes).substring(0, 7);
                var wtResult = com.codepal.worktree.AgentWorktree.create(
                        slug, worktreeManager.getProjectRoot(), worktreeManager.getSymlinkDirs());
        ...
        // Spawn teammate
        try {
            var spawnResult = com.codepal.teams.SpawnDispatcher.spawnTeammate(
                    new com.codepal.teams.SpawnDispatcher.SpawnConfig(
