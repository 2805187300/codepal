...
public class ToolRegistry {
    ...
    public static ToolRegistry createDefault() {
        ...
        reg.register(new com.codepal.tool.impl.ReadFileTool());
        reg.register(new com.codepal.tool.impl.WriteFileTool());
        reg.register(new com.codepal.tool.impl.EditFileTool());
        reg.register(new com.codepal.tool.impl.BashTool());
        reg.register(new com.codepal.tool.impl.GlobTool());
        reg.register(new com.codepal.tool.impl.GrepTool());
        return reg;
    }
}
