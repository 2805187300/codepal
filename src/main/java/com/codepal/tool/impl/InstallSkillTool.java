...
import com.codepal.skill.InstallReport;
import com.codepal.skill.SkillCatalog;
import com.codepal.skill.SkillInstaller;
import com.codepal.skill.SkillSource;
...
/**
 * 从 URL 下载并安装 skill 到用户全局目录 (~/.codepal/skills/)。
 * <p>
...
public class InstallSkillTool implements Tool {
    ...
    private static final String DESCRIPTION =
            ...
            + "(~/.codepal/skills/). Supports skills.sh URLs (https://www.skills.sh/<owner>/<repo>/<name>), "
    ...
    private String installRoot;   // 为空时自动取 ~/.codepal/skills
