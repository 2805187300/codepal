...
package com.codepal.tui.dialog;

import com.codepal.tui.Styles;
import com.codepal.tui.tea.Style;
import com.codepal.tui.tea.ANSI256Color;
 ...
 * It is driven by {@code CodePalModel}, which calls {@link #handleKey(String)}
 * on every key press and {@link #render()} each frame.
 *
 * @see com.codepal.tui.CodePalModel
 */
public class PlanApprovalDialog {
    ...
    public String render() {
        ...
        sb.append(HEADER_STYLE.render(
                " CodePal has written up a plan and is ready to execute. Would you like to proceed?"));
        sb.append("\n\n");
